...
def prepare_dataframe(df):
    """ฟังก์ชันกลางสำหรับทำความสะอาดและแปลงชนิดข้อมูลของ DataFrame จาก Google Sheet"""
    ...
    if st.button("เชื่อมต่อ / รีเฟรชข้อมูล", type="primary"):
        with st.spinner("กำลังเชื่อมต่อ..."):
            ...
            if st.session_state.worksheet:
                ...
                st.session_state.df = prepare_dataframe(source_df) # ใช้ prepare_dataframe แค่ครั้งเดียวตรงนี้
